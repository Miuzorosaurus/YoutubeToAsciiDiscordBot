...
@bot.command(brief="Plays a video url in ascii", description="Usage: !ascii Youtube_Link. Options: width=number(between 5 and 44, default is 44), height=number(between 5 and 22, default is 22), frameskip=number(between 0 and 90, dictates how many frames to skip when playing, defaults to 5), mapping=number(1 to 3, select mapping technique(average,min-max,luminosity), defaults to 3), charset=number(1 or 2, 1 is more characters 2 is less characters, default is 2). Any incorrect commands entered will be replaced with defaults.")
